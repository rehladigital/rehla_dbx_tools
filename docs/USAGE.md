...
warehouse_list = client.workspace.list_sql_warehouses()
warehouse_get = client.workspace.get_sql_warehouse("wh-101")
warehouse_create = client.workspace.create_sql_warehouse({"name": "analytics-wh"})
warehouse_edit = client.workspace.edit_sql_warehouse("wh-101", {"cluster_size": "2X-Small"})
warehouse_delete = client.workspace.delete_sql_warehouse("wh-101")
pool_list = client.workspace.list_instance_pools()
pool_get = client.workspace.get_instance_pool("pool-101")
pool_create = client.workspace.create_instance_pool({"instance_pool_name": "etl-pool"})
pool_edit = client.workspace.edit_instance_pool("pool-101", {"min_idle_instances": 1})
pool_delete = client.workspace.delete_instance_pool("pool-101")
policy_list = client.workspace.list_cluster_policies()
policy_get = client.workspace.get_cluster_policy("policy-101")
policy_create = client.workspace.create_cluster_policy({"name": "job-policy"})
policy_edit = client.workspace.edit_cluster_policy("policy-101", {"name": "job-policy-v2"})
policy_delete = client.workspace.delete_cluster_policy("policy-101")
dbfs_list = client.workspace.list_dbfs("dbfs:/tmp")
dbfs_status = client.workspace.get_dbfs_status("dbfs:/tmp/file.txt")
dbfs_read = client.workspace.read_dbfs("dbfs:/tmp/file.txt", offset=0, length=1024)
dbfs_mkdirs = client.workspace.mkdirs_dbfs("dbfs:/tmp/new-dir")
dbfs_delete = client.workspace.delete_dbfs("dbfs:/tmp/file.txt", recursive=False)
