...
class WorkspaceClient(BaseDatabricksClient):
    ...
    def delete_marketplace_provider_personalization_request(self, request_id: str, api_version: str = "2.0") -> Any:
        self._require_non_empty_string(request_id, "request_id")
        return self.request_versioned(
            "DELETE",
            "marketplace-provider/personalization-requests",
    ...
    def get_sharing_provider_share(self, name: str, share_name: str, api_version: str = "2.1") -> Any:
        self._require_non_empty_string(name, "name")
    ...
    def update_sharing_provider_share(
        self, name: str, share_name: str, share_link_changes: dict[str, Any], api_version: str = "2.1"
    ) -> Any:
        self._require_non_empty_string(name, "name")
        self._require_non_empty_string(share_name, "share_name")
    ...
    def get_share_recipient_share(self, name: str, share_name: str, api_version: str = "2.1") -> Any:
        self._require_non_empty_string(name, "name")
        self._require_non_empty_string(share_name, "share_name")
        return self.request_versioned(
            "GET",
    ...
    def update_share_recipient_share(
        self, name: str, share_name: str, share_link_changes: dict[str, Any], api_version: str = "2.1"
    ) -> Any:
        self._require_non_empty_string(name, "name")
        self._require_non_empty_string(share_name, "share_name")
    ...
    def list_share_providers(self, name: str, api_version: str = "2.1") -> Any:
        self._require_non_empty_string(name, "name")
        return self.request_versioned(
            "GET",
            "unity-catalog",
    ...
    def get_share_provider(self, name: str, provider_name: str, api_version: str = "2.1") -> Any:
        self._require_non_empty_string(name, "name")
    ...
    def get_share_recipient_for_share(self, name: str, recipient_name: str, api_version: str = "2.1") -> Any:
        self._require_non_empty_string(name, "name")
