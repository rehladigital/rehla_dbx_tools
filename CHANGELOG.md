...
- Hardened Delta Sharing provider/recipient share-link validation to require non-empty payload objects for:
  - `create_sharing_provider_share`, `update_sharing_provider_share`
  - `create_share_recipient_share`, `update_share_recipient_share`
- Added regression tests for empty share-link payload rejection across provider-share and recipient-share create/update flows.
- Updated `docs/COMPLETE_TOOL_USAGE_REFERENCE.md` with provider/recipient share-link payload requirements.
- Bumped package version from `2.0.25` to `2.0.26`.
...
- Delta Sharing relationship-detail wrappers:
  - `get_sharing_provider_share`
  - `get_share_recipient_share`
- Endpoint catalog entries for provider/recipient share-detail routes.
- Regression test coverage for both share-detail wrappers in `tests/test_workspace_client.py`.

### Changed

- Updated README and `docs/COMPLETE_TOOL_USAGE_REFERENCE.md` with share-detail lookup methods.
- Bumped package version from `2.0.17` to `2.0.18`.
...
- Delta Sharing relationship-list wrappers:
  - `list_sharing_provider_shares`
  - `list_share_recipient_shares`
- Endpoint catalog entries for provider/recipient share-list routes.
- Regression test coverage for both share-list wrappers in `tests/test_workspace_client.py`.

### Changed

- Updated README and `docs/COMPLETE_TOOL_USAGE_REFERENCE.md` with these new Delta Sharing methods.
- Bumped package version from `2.0.14` to `2.0.15`.
